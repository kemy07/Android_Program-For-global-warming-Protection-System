...
public class GasGraph extends AppCompatActivity {
        ...
        mPostReference.child("PfPCc9312INByZYVzERwFCmV0bi1Readings")
                .addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        hrValue = dataSnapshot.child("gas").getValue(String.class);
...
public void onBackPressed() {
    startActivity(new Intent(GasGraph.this, CardViewChart.class));
    finish();
}
}